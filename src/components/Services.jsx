...
const Services = () => {
	return (
		<section className="max-w-7xl mx-auto border-b-2 mt-20 scroll-mt-40" id="services">
			<div className="my-20">
					...
					className="mb-12 mx-4 flex flex-col lg:flex-row">
						...
						${
							...
							<img src={service.image} alt={service.title}
								className="
								w-full h-[400px]
								lg:w-[600px] lg:h-[650px] rounded-lg object-cover
								sm:h-[500px]"/>
						</div>
						<div className={`lg:w-1/2 flex flex-col ${
							...
							<p className="mb-4 lg:tracking:wide text-lg
